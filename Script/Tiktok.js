...
^https?:\/\/.+\.tiktokv\.com\/aweme\/v2(\/feed\/.+) url 302 https://api.tiktokv.com/aweme/v1$1
https?:\/\/.*\.tiktokv\.com\/aweme\/v\d\/((follow\/)?feed|(((multi\/)?aweme\/))?(favorite|post|detail)) url script-response-body https://gitee.com/bp233/script/raw/master/script/tiktok.js
[MITM]
...
http-request https:\/\/.+(tiktokv|byteoversea)\.com\/.+\=CN.+ script-path=https://gitee.com/bp233/script/raw/master/script/tiktok.js, requires-body=false, timeout=10, tag=tiktok

http-response https?:\/\/.*\.tiktokv\.com\/aweme\/v\d\/((follow\/)?feed|(((multi\/)?aweme\/))?(favorite|post|detail)) script-path=https://gitee.com/bp233/script/raw/master/script/tiktok.js, requires-body=true, timeout=10, tag=tiktok去水印
[MITM]
hostname = *.byteoversea.com,*.tiktokv.com
